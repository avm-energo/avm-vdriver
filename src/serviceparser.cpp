...
bool ServiceParser::InitCom(TCPClient *client, Settings::DeviceStruct dev) {

  foreach (auto port, dev.ports) {
    if (port.use) {
    }
  }
...
void ServiceParser::newDataServiceReceived(QByteArray &ba) {}
